            ...
            const SERVICE_PROGRAMS_MAP = {
                'art-playback': {
                    ...
                    EN: {
                        ...
                        html: `<div class="word-doc-container">
                            <div class="word-quote-box">“Playback Theatre — a transformative space where your personal story becomes spontaneous art on stage.”</div>
                            <p>Playback Theatre is a unique, interactive form of improvisational art. Audience members share real stories, memories, or feelings from their lives, and our professional ensemble of actors and live musicians immediately bring them to life on stage without any prior rehearsal.</p>
                            <div class="word-card-box teal-tint">
                                <h4>🌟 What You Experience at Playback Theatre:</h4>
                                <ul class="word-list">
                                    <li>Reflecting on your own story from an empowering new perspective;</li>
                                    <li>Deep empathy, shared vulnerability, and genuine human connection;</li>
                                    <li>Catharsis and emotional rejuvenation in a warm, welcoming space.</li>
                                </ul>
                            </div>
                        </div>`
                    }
                ...
                'art-therapy': {
                    ...
                    KA: {
                        ...
                        html: `<div class="word-doc-container">
                            ...
                            <div class="word-card-box teal-tint">
                                <h4>🎨 რას გვაძლევს არტ-თერაპია:</h4>
                                <ul class="word-list">
                                    <li>სტრესის, შფოთვისა და დაგროვილი დაღლილობის მოხსნა;</li>
                                    <li>შემოქმედებითი ინტუიციისა და შინაგანი ბალანსის გააქტიურება;</li>
                                    <li>არავერბალური ემოციების უსაფრთხო გადამუშავება.</li>
                                </ul>
                            </div>
                        </div>`
                    },
                    EN: {
                        ...
                        html: `<div class="word-doc-container">
                            <div class="word-quote-box">“Art unlocks pathways to subconscious emotions that words often fail to convey.”</div>
                            <p>Art therapy sessions are designed for emotional release, resolving internal conflicts, and self-discovery. Through visual arts, participants learn healthy and safe channels for emotional expression without fear of judgment.</p>
                            <div class="word-card-box teal-tint">
                                <h4>🎨 What You Gain:</h4>
                                <ul class="word-list">
                                    <li>Release of stress, anxiety, and accumulated fatigue;</li>
                                    <li>Awakening creative intuition and inner harmony;</li>
                                    <li>Safe non-verbal processing of deep emotional experiences.</li>
                                </ul>
                            </div>
                        </div>`
                    }
                ...
                'art-ceramic': {
                    ...
                    KA: {
                        ...
                        html: `<div class="word-doc-container">
                            ...
                            <div class="word-card-box teal-tint">
                                <h4>🏺 მასტერკლასის უპირატესობები:</h4>
                                <ul class="word-list">
                                    <li>კერამიკის ძერწვისა და მოჭიქურების საბაზისო ტექნიკები;</li>
                                    <li>მედიტაციური სიმშვიდე და ციფრული დეტოქსი ხელოვნების სტუდიაში;</li>
                                    <li>საკუთარი ხელით შექმნილი უნიკალური ნივთი სამახსოვროდ.</li>
                                </ul>
                            </div>
                        </div>`
                    },
                    EN: {
                        ...
                        html: `<div class="word-doc-container">
                            <div class="word-quote-box">“The tactile joy of handcrafting and meditative tranquility in clay and color.”</div>
                            <p>Hands-on ceramic and painting workshops where anyone can create their own bespoke ceramic piece or paint on canvas under the guidance of master artists.</p>
                            <div class="word-card-box teal-tint">
                                <h4>🏺 Masterclass Highlights:</h4>
                                <ul class="word-list">
                                    <li>Ceramic sculpting, wheel throwing, and glazing techniques;</li>
                                    <li>Meditative focus and digital detox in a boutique art studio;</li>
                                    <li>Take home your very own handmade art piece.</li>
                                </ul>
                            </div>
                        </div>`
                    }
                ...
                'art-performance': {
                    ...
                    KA: {
                        ...
                        html: `<div class="word-doc-container">
                            ...
                            <div class="word-card-box teal-tint">
                                <h4>🎶 პროგრამის თავისებურებები:</h4>
                                <ul class="word-list">
                                    <li>ცოცხალი აკუსტიკური პერფორმანსები კამერულ გარემოში;</li>
                                    <li>პოეზიისა და ლიტერატურული დიალოგების საღამოები;</li>
                                    <li>ესთეტიკური ღვინისა და მცენარეული ჩაის სტუმართმოყვარეობა.</li>
                                </ul>
                            </div>
                        </div>`
                    },
                    EN: {
                        ...
                        html: `<div class="word-doc-container">
                            <div class="word-quote-box">“Aesthetic pleasure, live acoustic music, and inspiring cultural salon evenings.”</div>
                            <p>Metaphora regularly hosts chamber acoustic concerts, poetry evenings, contemporary art exhibitions, and immersive performances that stimulate your creative senses.</p>
                            <div class="word-card-box teal-tint">
                                <h4>🎶 Evening Features:</h4>
                                <ul class="word-list">
                                    <li>Intimate acoustic sessions with celebrated musicians;</li>
                                    <li>Live poetry readings and philosophical salon dialogues;</li>
                                    <li>Aesthetic wine & artisanal tea hospitality in a serene atmosphere.</li>
                                </ul>
                            </div>
                        </div>`
                    }
                ...
                'club-third-place': {
                    ...
                    KA: {
                        ...
                        html: `<div class="word-doc-container">
                            ...
                            <div class="word-card-box teal-tint">
                                <h4>🏛️ რას გთავაზობთ საკლუბო სივრცე:</h4>
                                <ul class="word-list">
                                    <li>თბილი, შინაური გარემო საუბრებისა და განტვირთვისთვის;</li>
                                    <li>სათემო შეხვედრები, დისკუსიები და ახალი კონტაქტები;</li>
                                    <li>მყუდრო ნავსაყუდელი ახალი იდეების შთაგონებისთვის.</li>
                                </ul>
                            </div>
                        </div>`
                    },
                    EN: {
                        ...
                        html: `<div class="word-doc-container">
                            <div class="word-quote-box">“The Third Place — beyond home and workplace, where you feel truly at ease and understood.”</div>
                            <p>Metaphora’s club lounge unites thoughtful individuals seeking meaningful connections, stimulating conversations, and a comfortable haven for co-creation.</p>
                            <div class="word-card-box teal-tint">
                                <h4>🏛️ Club Atmosphere:</h4>
                                <ul class="word-list">
                                    <li>Warm, hospitable environment for casual & deep conversations;</li>
                                    <li>Exclusive community events, intellectual gatherings, and networking;</li>
                                    <li>Safe, inspiring harbor to relax your mind and spark new ideas.</li>
                                </ul>
                            </div>
                        </div>`
                    }
                ...
                'club-books': {
                    ...
                    KA: {
                        ...
                        html: `<div class="word-doc-container">
                            ...
                            <div class="word-card-box teal-tint">
                                <h4>📖 შეხვედრების ფორმატი:</h4>
                                <ul class="word-list">
                                    <li>თვიური გამორჩეული წიგნებისა და კინოკლასიკის ანალიზი;</li>
                                    <li>მოდერირებული დიალოგები ფსიქოლოგიასა და ფილოსოფიაზე;</li>
                                    <li>მყუდრო სალონური გარემო არომატული ჩაითა და სასიამოვნო მუსიკით.</li>
                                </ul>
                            </div>
                        </div>`
                    },
                    EN: {
                        ...
                        html: `<div class="word-doc-container">
                            <div class="word-quote-box">“Books and cinema masterpieces that prompt us to reflect on life’s essence.”</div>
                            <p>Moderated discussions centered around thought-provoking literature and cult cinema. Warm tea, intellectual debate, and deep psychological insights.</p>
                            <div class="word-card-box teal-tint">
                                <h4>📖 What We Explore:</h4>
                                <ul class="word-list">
                                    <li>Monthly curated books on philosophy, psychology, and personal growth;</li>
                                    <li>Screenings and psychological breakdown of classic cinema;</li>
                                    <li>Open discussions in an intimate, non-judgmental salon setting.</li>
                                </ul>
                            </div>
                        </div>`
                    }
                ...
                'club-board-games': {
                    ...
                    KA: {
                        ...
                        html: `<div class="word-doc-container">
                            ...
                            <div class="word-card-box teal-tint">
                                <h4>🎲 თამაშების საღამოები:</h4>
                                <ul class="word-list">
                                    <li>50-ზე მეტი საუკეთესო მსოფლიო სამაგიდო თამაშის კოლექცია;</li>
                                    <li>პროფესიონალი გეიმ-მასტერების ხელმძღვანელობა და წესების ახსნა;</li>
                                    <li>ჯანსაღი აზარტი, იუმორი და ახალი მეგობრები.</li>
                                </ul>
                            </div>
                        </div>`
                    },
                    EN: {
                        title: '🎲 Tabletop & Psychological Games',
                        html: `<div class="word-doc-container">
                            <div class="word-quote-box">“Play — the quickest path to genuine connection, relaxation, and strategic wit.”</div>
                            <p>Over 50 premium tabletop and psychological games guided by master facilitators: Mafia, Catan, Dixit, Codenames, and author-designed behavioral quests.</p>
                            <div class="word-card-box teal-tint">
                                <h4>🎲 Game Night Highlights:</h4>
                                <ul class="word-list">
                                    <li>Curated library of 50+ world-class strategy and party games;</li>
                                    <li>Professional game masters explaining rules and moderating play;</li>
                                    <li>Natural icebreaking and lively social dynamics.</li>
                                </ul>
                            </div>
                        </div>`
                    }
                ...
                'club-mastermind': {
                    ...
                    KA: {
                        ...
                        html: `<div class="word-doc-container">
                            ...
                            <div class="word-card-box teal-tint">
                                <h4>💻 სამუშაო სივრცის შესაძლებლობები:</h4>
                                <ul class="word-list">
                                    <li>მშვიდი, აკუსტიკურად დაბალანსებული ბუტიკ-ქოვორქინგი;</li>
                                    <li>სტრუქტურირებული Mastermind ფორმატი პროექტების განსახილველად;</li>
                                    <li>მაღალსიჩქარიანი ინტერნეტი, კომფორტული ავეჯი და ყავა/ჩაი.</li>
                                </ul>
                            </div>
                        </div>`
                    },
                    EN: {
                        title: '💻 Mastermind & Boutique Coworking Lounge',
                        html: `<div class="word-doc-container">
                            <div class="word-quote-box">“Focused deep work environment and collaborative mastermind brainstorming.”</div>
                            <p>Ergonomic workstations, high-speed WiFi, boutique meeting rooms, and peer-to-peer Mastermind sessions to accelerate business projects and creative ideas.</p>
                            <div class="word-card-box teal-tint">
                                <h4>💻 Facilities & Format:</h4>
                                <ul class="word-list">
                                    <li>Quiet, acoustic-balanced boutique coworking spaces;</li>
                                    <li>Structured peer mastermind formats for strategy validation;</li>
                                    <li>High-speed fiber connectivity, artisanal teas, and coffee.</li>
                                </ul>
                            </div>
                        </div>`
                    }
