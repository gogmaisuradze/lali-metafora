...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const EVENTS_DETAILS_DATABASE = {
        "0": {
                ...
                "KA": {
                        "title": "🎲 თამაშის არქიტექტორი - საბაზისო კურსი",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">━ ❖ ━</div>\n          <div class=\"word-section-title\">📌 პროგრამის აღწერა</div>\n          <p>ეს პროგრამა შექმნილია მათთვის, ვისაც სურს საგანმანათლებლო პროცესი (ტრენინგი, ლექცია, გაკვეთილი) აქციოს ინტერაქციულ თავგადასავლად და დაეუფლოს ჯგუფური დინამიკის მართვის ხელოვნებას.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">✨ რას მიიღებთ პროგრამის ფარგლებში?</div>\n            <ul class=\"word-list\">\n              <li><strong>50-ზე მეტი პრაქტიკული თამაშისა და აქტივობის ბაზას.</strong></li>\n              <li><strong>ენერგიის მართვისა და ფასილიტაციის</strong> ინსტრუმენტებს.</li>\n              <li><strong>საავტორო საგანმანათლებლო თამაშების</strong> შექმნის მეთოდოლოგიას.</li>\n              <li><strong>8 ინტენსიურ, პრაქტიკულ შეხვედრას</strong> (კვირაში ორჯერ, 3 საათი).</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">💰 ორგანიზაციული & ფინანსური დეტალები</div>\n          <table class=\"word-meta-table\">\n            <tr><td>🗓️ დაწყების თარიღი</td><td>ოქტომბერი 2026</td></tr>\n            <tr><td>⏰ განრიგი</td><td>კვირაში 2-ჯერ (18:30 - 21:30)</td></tr>\n            <tr><td>⏱️ ხანგრძლივობა</td><td>8 შეხვედრა (1 თვე)</td></tr>\n            <tr><td>📍 ლოკაცია</td><td>„მეტაფორა“ • აღმაშენებლის 63ა</td></tr>\n            <tr><td>🔄 გადახდის პირობები</td><td>შესაძლებელია ორ ნაწილად (50% რეგისტრაციისას, 50% მე-4 შეხვედრის შემდეგ)</td></tr>\n          </table>\n\n          <div class=\"word-quote-box\">\n            🚀 გელოდებით საგანმანათლებლო თავგადასავალში!\n          </div>\n        </div>\n      "
                },
                "EN": {
                        "title": "🎲 Game Architect - Basic Course",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">━ ❖ ━</div>\n          <div class=\"word-section-title\">📌 Program Overview</div>\n          <p>This program is crafted for educators, trainers, and facilitators who want to transform educational processes into interactive adventures and master group dynamics.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">✨ What You Will Gain:</div>\n            <ul class=\"word-list\">\n              <li><strong>50+ practical educational game & activity database.</strong></li>\n              <li><strong>Energy management & dynamic facilitation</strong> tools.</li>\n              <li><strong>Original game creation methodology</strong> from scratch.</li>\n              <li><strong>8 intensive live sessions</strong> (twice a week, 3 hours).</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">💰 Organizational Details</div>\n          <table class=\"word-meta-table\">\n            <tr><td>🗓️ Schedule</td><td>Twice a week (18:30 - 21:30)</td></tr>\n            <tr><td>⏱️ Duration</td><td>8 Sessions (1 Month)</td></tr>\n            <tr><td>📍 Location</td><td>Metaphora • 63a Aghmashenebeli</td></tr>\n            <tr><td>🔄 Payment</td><td>Split into 2 installments (50% registration, 50% mid-course)</td></tr>\n          </table>\n        </div>\n      "
                }
        },
        "1": {
                "id": 1,
                ...
                "KA": {
                        "title": "🏗️ თამაშის არქიტექტორი - ჩაღრმავებული კურსი",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">━ ❖ ━</div>\n          <p>ეს პროგრამა განკუთვნილია მათთვის, ვინც უკვე ფლობს არაფორმალურ განათლებაში თამაშების გამოყენების საბაზისო ინსტრუმენტებს და ახლა სურს, თამაშების გამოყენებიდან მათ პროფესიულ დიზაინსა და მართვაზე გადავიდეს.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">🎯 ეს კურსი შენთვისაა, თუ:</div>\n            <ul class=\"word-list\">\n              <li>გაიარე „თამაშის არქიტექტორის“ საბაზისო კურსი; ან</li>\n              <li>ხარ გამოცდილი ტრენერი/ფასილიტატორი და გსურს შენი პრაქტიკა უფრო სტრუქტურირებული და მეცნიერულად დასაბუთებული გახადო;</li>\n              <li>უკვე იყენებ თამაშებს, მაგრამ გინდა ისწავლო მათი „ნულიდან“ შექმნა ნებისმიერი კონტექსტისთვის.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">🚀 გემიფიკაციის 5 მთავარი სვეტი (6 შეხვედრა):</div>\n          <div class=\"meeting-timeline-grid\">\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">1</span>\n              <div class=\"meeting-info\"><strong>ბალანსი და დინამიკა (Flow Theory)</strong><span>როგორ შევქმნათ გამოწვევა, რომელიც მონაწილეს არც დაღლის და არც მოაწყენს.</span></div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">2</span>\n              <div class=\"meeting-info\"><strong>უკუკავშირის მექანიზმები</strong><span>როგორ ჩავრთოთ თამაშში სწრაფი რეაგირების სისტემები, რაც მოტივაციას ინარჩუნებს.</span></div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">3</span>\n              <div class=\"meeting-info\"><strong>პროგრესის არქიტექტურა</strong><span>როგორ დავყოთ პროცესი საფეხურებად (Level-ებად), რომ მონაწილემ ზრდა იგრძნოს.</span></div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">4</span>\n              <div class=\"meeting-info\"><strong>შეზღუდვების ძალა</strong><span>როგორ აქცევს წესები და ლიმიტები ჩვეულებრივ აქტივობას კრეატიულ თავგადასავლად.</span></div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">5</span>\n              <div class=\"meeting-info\"><strong>დებრიფინგის ოსტატობა</strong><span>როგორ ამოვიღოთ თამაშიდან ის „ნედლეული“, რომელიც რეალურ ქცევით ცვლილებას მოიტანს.</span></div>\n            </div>\n          </div>\n\n          <div class=\"word-section-title\">📅 ორგანიზაციული დეტალები</div>\n          <table class=\"word-meta-table\">\n            <tr><td>⏱️ ხანგრძლივობა</td><td>6 შეხვედრა (თითო 4 საათი)</td></tr>\n            <tr><td>🎯 ფორმატი</td><td>ცოცხალი პრაქტიკუმი + დემო-თამაშები + ინდივიდუალური უკუკავშირი</td></tr>\n            <tr><td>⏰ დრო</td><td>საღამოს 19:00 - 23:00</td></tr>\n            <tr><td>📍 ლოკაცია</td><td>„მეტაფორა“ • აღმაშენებლის 63ა</td></tr>\n            <tr><td>🛡️ უსაფრთხო სივრცე</td><td>თავისუფლება ვალდებულებებისგან. არავინ არავის არაფერს ავალდებულებს, გარდა გულწრფელი ყურადღებისა.</td></tr>\n          </table>\n        </div>\n      "
                },
                "EN": {
                        "title": "🏗️ Game Architect - Advanced Mastery",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">━ ❖ ━</div>\n          <p>Designed for seasoned trainers and educators ready to transition from playing games to professional game architecture and behavioral system design.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">🚀 5 Pillars of Gamification:</div>\n            <ul class=\"word-list\">\n              <li><strong>1. Balance & Flow Theory:</strong> Calibrating challenge vs boredom.</li>\n              <li><strong>2. Feedback Loops:</strong> Instant gratification and sustained engagement.</li>\n              <li><strong>3. Progress Architecture:</strong> Level design and growth momentum.</li>\n              <li><strong>4. Constructive Constraints:</strong> Turning boundaries into creative exploration.</li>\n              <li><strong>5. Debriefing Mastery:</strong> Extracting actionable behavioral shifts.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">📅 Organizational Details</div>\n          <table class=\"word-meta-table\">\n            <tr><td>⏱️ Duration</td><td>6 Sessions (4 hours each)</td></tr>\n            <tr><td>🎯 Format</td><td>Live Lab + Prototyping + 1-on-1 Feedback</td></tr>\n            <tr><td>⏰ Time</td><td>19:00 - 23:00</td></tr>\n            <tr><td>📍 Location</td><td>Metaphora • 63a Aghmashenebeli</td></tr>\n          </table>\n        </div>\n      "
                }
        },
        "2": {
                "id": 2,
                ...
                "time": "18:00",
                "KA": {
                        "title": "🌿 პიროვნული განვითარების პროგრამა - არიტე",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-quote-box\">\n            „არეტე (ἀρετή) — ძველბერძნული ცნებაა: გახდე საუკეთესო, რაც შეგიძლია იყო.“\n          </div>\n          <p>არიტე პიროვნული განვითარების პრაქტიკული პროგრამების ციკლია მათთვის, ვისაც საკუთარ თავზე მუშაობა და რეალურ ცხოვრებაში ახალი გზების მოსინჯვა სურს. აქ ნაკლებია მზა პასუხები და მეტი — პრაქტიკა, გამოცდილება, ექსპერიმენტი, უკუკავშირი და რეფლექსია.</p>\n\n          <div class=\"word-section-title\">🌿 არიტეს 4 დამოუკიდებელი მოდული:</div>\n\n          <div class=\"word-card-box teal-tint\" style=\"margin-bottom:10px;\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">მოდული 1. მე და სხვები</div>\n            <p style=\"font-size:0.88rem; margin:0 0 6px 0;\"><em>როგორი ვარ მე სხვებთან? და რა ხდება ჩემთან და ჩემში, როცა სხვებთან ვარ?</em></p>\n            <ul class=\"word-list\">\n              <li>საკუთარი ქცევისა და ჩვეული რეაქციების უკეთ დანახვა;</li>\n              <li>კომუნიკაცია და სხვებთან ურთიერთობა;</li>\n              <li>საკუთარი პოზიციის, არჩევანისა და პასუხისმგებლობის გაცნობიერება;</li>\n              <li>უკუკავშირის მიღება და გამოყენება;</li>\n              <li>სხვების უკეთ გაგება და ურთიერთობაში მეტი მოქნილობის განვითარება.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-card-box teal-tint\" style=\"margin-bottom:10px;\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">მოდული 2. ემოციების სამყარო</div>\n            <p style=\"font-size:0.88rem; margin:0 0 6px 0;\"><em>საკუთარ ემოციებს ვაკვირდებით, ვეცნობით და მათ მართვას ვსწავლობთ.</em></p>\n            <ul class=\"word-list\">\n              <li>ემოციებს, აზრებსა და ქცევას შორის კავშირის დანახვა;</li>\n              <li>საკუთარი ემოციური მდგომარეობის მართვა;</li>\n              <li>ავტომატური და იმპულსური რეაქციების გაცნობიერება;</li>\n              <li>სასურველი ემოციური მდგომარეობის შექმნა და შენარჩუნება.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-card-box teal-tint\" style=\"margin-bottom:10px;\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">მოდული 3. წარმატებული ადამიანი</div>\n            <p style=\"font-size:0.88rem; margin:0 0 6px 0;\"><em>ვმუშაობთ საკუთარ მიზნებზე, არჩევანსა და რეალურ მოქმედებებზე.</em></p>\n            <ul class=\"word-list\">\n              <li>სურვილების, მიზნებისა და პრიორიტეტების გარკვევა;</li>\n              <li>წარმატების საკუთარი კრიტერიუმების ჩამოყალიბება;</li>\n              <li>გადაწყვეტილების მიღება და საკუთარ არჩევანზე პასუხისმგებლობის აღება;</li>\n              <li>მიზნების კონკრეტულ მოქმედებად გარდაქმნა.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-card-box teal-tint\" style=\"margin-bottom:10px;\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">მოდული 4. ძნელი თამაშები</div>\n            <p style=\"font-size:0.88rem; margin:0 0 6px 0;\"><em>საკუთარ თავს უჩვეულო, რთულ და პროვოკაციულ სიტუაციებში გამოვცდით.</em></p>\n            <ul class=\"word-list\">\n              <li>რთულ და მოულოდნელ სიტუაციებში საკუთარ რეაქციებზე დაკვირვება;</li>\n              <li>გადაწყვეტილების მიღება და პასუხისმგებლობა გაურკვევლობაში;</li>\n              <li>თანამშრომლობა, კონკურენცია და კონფლიქტი;</li>\n              <li>ლიდერობა და ჯგუფში საკუთარი როლის მართვა.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">🗓️ ფორმატი და გრაფიკი</div>\n          <table class=\"word-meta-table\">\n            <tr><td>⏱️ თითო მოდული</td><td>1 თვე | 8 შეხვედრა | კვირაში 2-ჯერ | 3 საათი</td></tr>\n            <tr><td>👥 ჯგუფი</td><td>20–25 მონაწილე</td></tr>\n            <tr><td>📍 ლოკაცია</td><td>„მეტაფორა“ • აღმაშენებლის 63ა</td></tr>\n          </table>\n        </div>\n      "
                },
                "EN": {
                        "title": "🌿 Program Arete - Personal Development",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-quote-box\">\n            “Arete (ἀρετή) — Ancient Greek: Becoming the best version of who you can be.”\n          </div>\n          <p>Arete is a cycle of practical personal development modules for those ready to experiment with new behaviors, self-reflection, and real growth.</p>\n\n          <div class=\"word-section-title\">🌿 4 Core Modules:</div>\n          <ul class=\"word-list\">\n            <li><strong>Module 1: Me & Others</strong> — Relational dynamics, feedback, and behavioral agility.</li>\n            <li><strong>Module 2: World of Emotions</strong> — Emotional regulation, triggers, and state management.</li>\n            <li><strong>Module 3: Successful Individual</strong> — Goal clarity, priorities, and action execution.</li>\n            <li><strong>Module 4: Difficult Games</strong> — Decision making under pressure, conflict resolution, and leadership.</li>\n          </ul>\n\n          <table class=\"word-meta-table\">\n            <tr><td>⏱️ Duration</td><td>Each Module: 1 Month | 8 Sessions | 3 Hours each</td></tr>\n            <tr><td>👥 Group</td><td>20-25 Participants</td></tr>\n            <tr><td>📍 Location</td><td>Metaphora • 63a Aghmashenebeli</td></tr>\n          </table>\n        </div>\n      "
                }
        },
        "3": {
                "id": 3,
                ...
                "KA": {
                        "title": "❤️ სიყვარულის ხელოვნება & სიყვარულის 5 ენა",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-quote-box\">\n            „შეიძლება გვიყვარდეს — და მაინც მეორე ადამიანი ამას ისე ვერ გრძნობდეს, როგორც ჩვენ გვგონია.“\n          </div>\n          <p>გარი ჩაპმანის მოდელის მიხედვით, ადამიანები სიყვარულს სხვადასხვა გზით გამოხატავენ და ღებულობენ. როცა პარტნიორები განსხვავებულ „ენებზე“ საუბრობენ, იწყება ემოციური გაუცხოება.</p>\n\n          <div class=\"word-section-title\">❤️ სიყვარულის 5 ენა — გარი ჩაპმანის მოდელი:</div>\n          <div class=\"meeting-timeline-grid\">\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">1</span>\n              <div class=\"meeting-info\"><strong>აღიარების სიტყვები (Words of Affirmation)</strong><span>კომპლიმენტები, მხარდაჭერა, სიტყვიერი მადლიერება და აღიარება.</span></div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">2</span>\n              <div class=\"meeting-info\"><strong>ხარისხიანი დრო (Quality Time)</strong><span>გაუყოფელი ყურადღება, ერთობლივი საუბარი და საერთო აქტივობები ტელეფონებისა და ხელისშემშლელების გარეშე.</span></div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">3</span>\n              <div class=\"meeting-info\"><strong>საჩუქრები (Receiving Gifts)</strong><span>სიყვარულის ვიზუალური სიმბოლოები, ყურადღების ნიშნები და მზრუნველობა.</span></div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">4</span>\n              <div class=\"meeting-info\"><strong>მზრუნველობა და საქმით დახმარება (Acts of Service)</strong><span>ქმედებები, რომლებიც მეორე ადამიანს უმსუბუქებს ყოველდღიურობას.</span></div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">5</span>\n              <div class=\"meeting-info\"><strong>ფიზიკური შეხება (Physical Touch)</strong><span>ჩახუტება, ხელის ჩაკიდება, სითბო და ფიზიკური სიახლოვე.</span></div>\n            </div>\n          </div>\n\n          <div class=\"word-section-title\">✨ რას მიიღებთ მასტერკლასზე?</div>\n          <ul class=\"word-list\">\n            <li>ამოიცნობთ თქვენს და თქვენი პარტნიორის წამყვან სიყვარულის ენას;</li>\n            <li>გაიგებთ ემოციური დისტანციისა და გაუცხოების ფარულ მიზეზებს;</li>\n            <li>ისწავლით პარტნიორის „ენაზე“ კომუნიკაციას და ჰარმონიული ურთიერთობის შექმნას.</li>\n          </ul>\n        </div>\n      "
                },
                "EN": {
                        "title": "❤️ Art of Loving & 5 Love Languages",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-quote-box\">\n            “We may love deeply — yet our partner might not feel it the way we intended.”\n          </div>\n          <p>Based on Gary Chapman's model, discover the 5 distinct ways humans give and perceive love, and how speaking your partner's emotional language creates profound closeness.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">❤️ The 5 Love Languages:</div>\n            <ul class=\"word-list\">\n              <li><strong>1. Words of Affirmation:</strong> Verbal praise, appreciation, and encouragement.</li>\n              <li><strong>2. Quality Time:</strong> Undivided presence and meaningful moments.</li>\n              <li><strong>3. Receiving Gifts:</strong> Visual symbols of love and thoughtfulness.</li>\n              <li><strong>4. Acts of Service:</strong> Easing burdens through supportive actions.</li>\n              <li><strong>5. Physical Touch:</strong> Warmth, hugs, and physical reassurance.</li>\n            </ul>\n          </div>\n        </div>\n      "
                }
        },
        "4": {
                "id": 4,
                ...
                "KA": {
                        "title": "🎓 ტრენერობის ხელოვნება - ტრენერის გზა",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-quote-box\">\n            „ერთი რუკა. ბევრი მარშრუტი. საკუთარი გზა ტრენერობის ოსტატობისკენ.“\n          </div>\n          <p><strong>„ტრენერის გზა“</strong> ტრენერებისა და ფასილიტატორების პროფესიული განვითარების მოდულური ეკოსისტემაა. პროგრამა შექმნილია პრაქტიკოსებისთვის, რომელთაც სურთ საკუთარი მეთოდოლოგიის გამრავალფეროვნება და უმაღლეს დონეზე აყვანა.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">🎓 ძირითადი მოდულები:</div>\n            <ul class=\"word-list\">\n              <li><strong>საგანმანათლებლო პროგრამის არქიტექტურა:</strong> სასწავლო მიზნების დაგეგმვა, სტრუქტურირება და მეთოდოლოგია.</li>\n              <li><strong>ზრდასრულთა სწავლების ფსიქოლოგია (ანდრაგოგიკა):</strong> როგორ აღიქვამენ და ითვისებენ ცოდნას ზრდასრულები.</li>\n              <li><strong>ინტერაქციული ფასილიტაცია:</strong> ჯგუფური ენერგიის, ყურადღებისა და ჩართულობის მართვა.</li>\n              <li><strong>რთული აუდიტორიის მართვა:</strong> პროვოკაციების, წინააღმდეგობისა და კრიზისული სიტუაციების ნეიტრალიზება.</li>\n              <li><strong>ავთენტური ტრენერული სტილი:</strong> საკუთარი უნიკალური ხელწერის პოვნა და დახვეწა.</li>\n            </ul>\n          </div>\n        </div>\n      "
                },
                "EN": {
                        "title": "🎓 The Art of Training - Trainer's Path",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-quote-box\">\n            “One comprehensive map. Many distinct routes. Your personal path to training mastery.”\n          </div>\n          <p>A modular professional ecosystem for facilitators and trainers seeking to master adult instructional design, audience psychology, and dynamic group leadership.</p>\n        </div>\n      "
                }
        },
        "5": {
                "id": 5,
        ...
        "7": {
                ...
                "time": "19:30",
                "KA": {
                        "title": "❤️ „რატომ გვტკივა სიყვარული“",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <div class=\"word-quote-box\">\n            — „რატომ მეორდება ერთი და იგივე სცენარი?“<br>\n            — „რატომ მეშინია დაკარგვის, სიახლოვის ან უარყოფის?“<br>\n            — „რატომ მტკივა სიყვარული, როცა წესით უნდა მაბედნიერებდეს?“\n          </div>\n          <p>სიყვარული მხოლოდ რომანტიკა არ არის. ხშირად ის ეხება ჩვენს ბავშვობას, მიჯაჭვულობის სტილს, დაუმუშავებელ ტკივილებს, ოჯახურ სისტემას და იმ ნაწილებს, რომლებიც ჯერ კიდევ ელოდებიან მიღებას. ამ ვორქშოფზე სიყვარულს შევხედავთ როგორც სარკეს, რომელიც ჩვენს შინაგან სამყაროს გვაჩვენებს.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">✨ რას მიიღებთ ვორქშოფის ფარგლებში?</div>\n            <ul class=\"word-list\">\n              <li>უკეთ გაიგებთ, რატომ გიზიდავთ კონკრეტული ტიპის ადამიანები;</li>\n              <li>აღმოაჩენთ თქვენს ურთიერთობებში განმეორებად პატერნებს;</li>\n              <li>გაიაზრებთ, როგორ მოქმედებს ბავშვობის გამოცდილება სიყვარულზე;</li>\n              <li>შეისწავლით შფოთვითი, არიდებითი და უსაფრთხო მიჯაჭვულობის დინამიკას;</li>\n              <li>მიიღებთ პრაქტიკულ სავარჯიშოებს თვითშეფასებისა და ემოციური ცნობიერებისთვის;</li>\n              <li>შეძლებთ სიყვარულზე ახალი, უფრო ჯანსაღი ხედვის შექმნას.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">🧠 რა თემებს შევეხებით?</div>\n          <ul class=\"word-list\">\n            <li>რატომ გვიზიდავს ემოციურად მიუწვდომელი ადამიანი;</li>\n            <li>შიში: მიტოვება vs სიახლოვე;</li>\n            <li>ტკივილი, დამოკიდებულება და სიყვარული;</li>\n            <li>„რატომ არ ვარ საკმარისი?“;</li>\n            <li>მიჯაჭვულობის სტილები ურთიერთობაში;</li>\n            <li>როგორ შევქმნათ უსაფრთხო კავშირი.</li>\n          </ul>\n\n          <div class=\"word-section-title\">🎯 ვისთვის არის ეს ვორქშოფი?</div>\n          <p>მათთვის, ვისაც სიყვარულში ხშირად სტკივა, იმეორებს ერთსა და იმავე სცენარებს, უჭირს ადამიანების გაშვება ან ეშინია დაკარგვის/უარყოფის.</p>\n        </div>\n      "
                },
                "EN": {
                        "title": "❤️ Why Love Hurts & Repeating Patterns",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <div class=\"word-quote-box\">\n            “Why do the same relationship scripts keep replaying?”\n          </div>\n          <p>Examine how attachment wounds, childhood dynamics, and subconscious expectations shape our romantic patterns, and learn how to build secure, lasting emotional intimacy.</p>\n        </div>\n      "
                }
        },
        "8": {
                "id": 8,
                ...
                "KA": {
                        "title": "📦 „რა შევუკვეთე და რა ჩამომივიდა“",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <div class=\"word-quote-box\">\n            „სულ სხვა რამ მინდოდა… და სრულიად სხვა რეალობა მივიღე.“\n          </div>\n          <p>მასტერკლასი შექმნილია მათთვის, ვისაც ცხოვრებაში, ურთიერთობებში, კარიერაში ან საკუთარ თავთან აქვს განცდა, რომ სასურველსა და რეალობას შორის აცდენაა. განვიხილავთ, თუ როგორ ვაკეთებთ არჩევანს, რატომ ვიმეორებთ ერთსა და იმავე სცენარებს და როგორ დავინახოთ განსხვავება ჩვენს ნამდვილ სურვილსა და იმ რეალობას შორის, რომელსაც ხშირად გაუცნობიერებლად „ვუკვეთავთ“.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">✨ რას მიიღებთ მასტერკლასის ფარგლებში?</div>\n            <ul class=\"word-list\">\n              <li>გააცნობიერებთ, სად არის სხვაობა თქვენს სურვილსა და მიღებულ შედეგს შორის;</li>\n              <li>დაინახავთ განმეორებად ცხოვრებისეულ პატერნებს ურთიერთობებში, სამსახურში, ფულთან და საკუთარ თავთან მიმართებაში;</li>\n              <li>გაიგებთ, რას „უკვეთავთ“ რეალურად თქვენი შიშებით, რწმენებითა და შინაგანი პროგრამებით;</li>\n              <li>იმუშავებთ პრაქტიკულ სავარჯიშოებზე, რომლებიც დაგეხმარებათ უფრო ცნობიერ არჩევანში;</li>\n              <li>მიიღებთ ახალ ხედვას: როგორ გადავიდეთ შემთხვევითი რეალობიდან გაცნობიერებულად შექმნილ რეალობაზე.</li>\n            </ul>\n          </div>\n        </div>\n      "
                },
                "EN": {
                        "title": "📦 What I Ordered vs What Arrived",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <div class=\"word-quote-box\">\n            “I wanted one thing… yet arrived somewhere entirely different.”\n          </div>\n          <p>A transformative masterclass bridging conscious desires and subconscious programming across relationships, career, and life choices.</p>\n        </div>\n      "
                }
        },
        "9": {
                "id": 9,
                ...
                "time": "18:00",
                "KA": {
                        "title": "🌌 „სისტემური განლაგება“ - სიღრმისეული ვორქშოფი",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <p>სისტემური განლაგება არის სიღრმისეული მეთოდი, რომელიც საშუალებას გაძლევთ დაინახოთ ის უხილავი კავშირები, რომლებიც მართავენ თქვენს არჩევანს, ურთიერთობებს, ფინანსებსა და ემოციურ მდგომარეობას. ხშირად ის, რაც პირად პრობლემად გვეჩვენება, ოჯახური სისტემის გადაუჭრელი სცენარია.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">✨ რას მიიღებთ ვორქშოფზე?</div>\n            <ul class=\"word-list\">\n              <li>დაინახავთ თქვენს ცხოვრებაში არსებული სირთულეების რეალურ, სისტემურ მიზეზებს;</li>\n              <li>გააცნობიერებთ წინაპართაგან გადმოცემულ განმეორებად სცენარებსა და ლოიალობებს;</li>\n              <li>გაათავისუფლებთ ემოციურ ტვირთს, რომელიც თქვენ არ გეკუთვნით;</li>\n              <li>აღადგენთ სასიცოცხლო ენერგიის ნაკადს ოჯახურ და პირად სისტემაში;</li>\n              <li>იპოვით თქვენს სწორ ადგილს სისტემაში, რაც სიმშვიდესა და თავდაჯერებულობას მოგიტანთ.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">🧠 ძირითადი თემები:</div>\n          <ul class=\"word-list\">\n            <li>ოჯახური და საგვარეულო სისტემების ფარული დინამიკები;</li>\n            <li>ფინანსური და კარიერული ბლოკები სისტემურ ჭრილში;</li>\n            <li>განმეორებადი განქორწინებები, დანაკარგები და დაავადებები;</li>\n            <li>საკუთარი ადგილის დაბრუნება და რესურსების განბლოკვა.</li>\n          </ul>\n        </div>\n      "
                },
                "EN": {
                        "title": "🌌 Systemic Constellations - Deep Workshop",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <p>Uncover invisible generational loyalties, family scripts, and systemic blockages to reclaim your personal energy and inner balance.</p>\n        </div>\n      "
                }
        },
        "10": {
                "id": 10,
                ...
                "KA": {
                        "title": "💰 „ფული, თუ პასუხისმგებლობა“",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <div class=\"word-quote-box\">\n            — „რატომ არ იზრდება ჩემი შემოსავალი?“<br>\n            — „რატომ ვერ ვინარჩუნებ ფულს?“<br>\n            — „რატომ მაქვს შინაგანი დაძაბულობა ფულთან დაკავშირებით?“\n          </div>\n          <p>ფული მხოლოდ ეკონომიკური ერთეული არ არის. ის მჭიდროდ არის დაკავშირებული ჩვენს ემოციებთან, თვითშეფასებასთან, ოჯახურ პროგრამებთან, პასუხისმგებლობასთან და შინაგან საზღვრებთან.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">✨ რას მიიღებთ ვორქშოფის ფარგლებში?</div>\n            <ul class=\"word-list\">\n              <li>გააცნობიერებთ თქვენს ქვეცნობიერ დამოკიდებულებას ფულთან;</li>\n              <li>დაინახავთ ფინანსურ ჭერებს და შინაგან ბარიერებს;</li>\n              <li>გაიგებთ, როგორ უკავშირდება პასუხისმგებლობა ფინანსურ ზრდას;</li>\n              <li>აღმოაჩენთ ოჯახურ ფინანსურ სცენარებსა და შეზღუდვებს;</li>\n              <li>ისწავლით ფულის მიღებას, შენარჩუნებასა და მართვას დანაშაულის გრძნობის გარეშე.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">🧠 რა თემებს შევეხებით?</div>\n          <ul class=\"word-list\">\n            <li>ფინანსური თვითსაბოტაჟი და სიღარიბის ქვეცნობიერი პროგრამები;</li>\n            <li>ოჯახური სცენარები და ფული;</li>\n            <li>ფული, სირცხვილი და ღირსება;</li>\n            <li>წარმატების შიში — „თუ გავიზრდები, რას დავკარგავ?“;</li>\n            <li>მიღების და შენარჩუნების უნარი.</li>\n          </ul>\n        </div>\n      "
                },
                "EN": {
                        "title": "💰 Money or Responsibility",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <div class=\"word-quote-box\">\n            “Money is not just currency — it follows energy, boundaries, and emotional ownership.”\n          </div>\n          <p>A deep masterclass uncovering financial self-sabotage, scarcity mindsets, and building an empowered relationship with wealth.</p>\n        </div>\n      "
                }
        },
        "11": {
                "id": 11,
                ...
                "KA": {
                        "title": "🌙 შეხვედრა შეჰერეზადასთან",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <div class=\"word-quote-box\">\n            „ყოველი ისტორია არის გასაღები, რომელიც აღებს ჩვენი ქვეცნობიერის იმ კარს, სადაც საუკეთესო გადაწყვეტილებები ინახება.“\n          </div>\n          <p>გაატარეთ 2 საათი მყუდრო, აღმოსავლურ ატმოსფეროში, აღმოაჩინეთ იგავების 15 თერაპიული საიდუმლო და იპოვეთ პასუხები საკუთარ თავში.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">✨ რით არის ეს საღამო უნიკალური?</div>\n            <ul class=\"word-list\">\n              <li><strong>აღმოსავლური გარემო & სამოსი:</strong> თითოეული მონაწილე მოირგებს აღმოსავლურ სამოსს/აქსესუარს ზღაპრული გარემოს მაგიის შესაგრძნობად.</li>\n              <li><strong>არომატული ჩაის რიტუალი:</strong> შინაურულ, თბილ გარემოში, ჩაის თანხლებით გავხსნით გულებს სიღრმისეული საუბრებისთვის.</li>\n              <li><strong>ისტორიები, როგორც თერაპია:</strong> ფსიქოთერაპევტ ლალი ბადრიძესთან ერთად გავშიფრავთ იგავების ფარულ შრეებს და გამოვიყენებთ მათ თვითშემეცნებისთვის.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">🧠 რატომ ისტორიები და მეტაფორები?</div>\n          <p>პოზიტიურ ფსიქოთერაპიაში ზღაპრებსა და იგავებს 15 განსხვავებული ფსიქოთერაპიული ფუნქცია აქვთ. ჩვენ გავშიფრავთ მათ ღრმა ქვეცნობიერ ასპექტებს და გამოვიყენებთ, როგორც სარკეს საკუთარი გამოწვევების გადასაჭრელად.</p>\n        </div>\n      "
                },
                "EN": {
                        "title": "🌙 Meeting with Scheherazade",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">❖   ❖   ❖</div>\n          <div class=\"word-quote-box\">\n            “Every story is a key that opens the subconscious room where your best answers reside.”\n          </div>\n          <p>An enchanting evening in positive psychotherapy with oriental storytelling, traditional tea ceremonies, and mythic therapeutic reflections led by Lali Badridze.</p>\n        </div>\n      "
                }
        },
        "12": {
                "id": 12,
                ...
                "KA": {
                        "title": "💬 „მოდი ვილაპარაკოთ“ - ექსპერიმენტული დიალოგი",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">━ ❖ ━</div>\n          <p><strong>„მოდი ვილაპარაკოთ“</strong> არის 1.5-საათიანი ცოცხალი ინტერაქციული შეხვედრა მყუდრო, უსაფრთხო და თავისუფალ გარემოში. არჩევანი სრულად მონაწილეზეა: ისაუბროს ერთ ან რამდენიმე ადამიანთან, იქნება ეს უცნობი თუ უკვე ნაცნობი პიროვნება.</p>\n\n          <div class=\"word-section-title\">⏱️ შეხვედრის სტრუქტურა და ეტაპები (90 წუთი):</div>\n\n          <div class=\"meeting-timeline-grid\">\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">I</span>\n              <div class=\"meeting-info\">\n                <strong>შესავალი და სივრცესთან შერწყმა (10-15 წუთი)</strong>\n                <span>არჩევანისა და შემთხვევითობის პრინციპი; ჩაი, ყავა, სასუსნავები; „წესების გარეშე წესები“ - სრული თავისუფლება.</span>\n              </div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">II</span>\n              <div class=\"meeting-info\">\n                <strong>ძირითადი დიალოგი და ექსპერიმენტი (60 წუთი)</strong>\n                <span>მოქნილი ფორმატი; გზამკვლევი ბარათები ღრმა და პროვოკაციული კითხვებით (ბავშვობა, სიყვარული, შინაგანი ძიებები, ოცნებები, კრიზისები, სამყაროს პასუხი).</span>\n              </div>\n            </div>\n            <div class=\"meeting-timeline-item\">\n              <span class=\"meeting-num\">III</span>\n              <div class=\"meeting-info\">\n                <strong>რეფლექსია და დასკვნა (10-15 წუთი)</strong>\n                <span>საკუთარი შინაგანი განცდებისა და მიღებული ემოციის გასააზრებელი სივრცე.</span>\n              </div>\n            </div>\n          </div>\n\n          <div class=\"word-card-box teal-tint\" style=\"margin-top:10px;\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">🛡️ მეთოდოლოგია & უსაფრთხო სივრცე:</div>\n            <p style=\"font-size:0.88rem; margin:0;\">დიალოგი, სადაც მეორე ადამიანი იქცევა შინაგანი ძიების პასუხად. ამ სივრცეში შემთხვევით არაფერი ხდება. თითოეული ადამიანი და შეხვედრისას ამოტივტივებული კითხვა არის მნიშვნელოვანი მინიშნება ცხოვრების გზაზე. თავისუფლება ვალდებულებებისგან — არავინ არავის არაფერს ავალდებულებს, გარდა გულწრფელი ყურადღებისა.</p>\n          </div>\n        </div>\n      "
                },
                "EN": {
                        "title": "💬 Let's Talk - Experimental Dialogue",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-divider\">━ ❖ ━</div>\n          <p>A 90-minute experimental dialogue format in a safe, authentic environment with curated prompt cards on deep life questions, synchronicity, and unscripted connection.</p>\n        </div>\n      "
                }
        },
        "13": {
                "id": 13,
                ...
                "KA": {
                        ...
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-quote-box\">\n            „სანამ არაცნობიერს ცნობიერად არ აქცევ, ის მართავს შენს ცხოვრებას და შენ მას ბედისწერას უწოდებ.“\n            <cite>— კარლ გუსტავ იუნგი</cite>\n          </div>\n          <p>დღევანდელ სამყაროში მენეჯმენტი აღარ არის მხოლოდ პროცესების მართვა — ეს არის ადამიანის სულის, მოტივებისა და ემოციების გაგების ხელოვნება. ყოველი თანამშრომლის მიღმა დგას არაცნობიერი შიშების, თავდაცვის მექანიზმებისა და კოგნიტური ხაფანგების მთელი სამყარო.</p>\n\n          <div class=\"word-card-box teal-tint\">\n            <div class=\"word-section-title\" style=\"margin-top:0;\">⚡ რას მიიღებ ამ კურსით?</div>\n            <ul class=\"word-list\">\n              <li><strong>არავერბალური დიაგნოსტიკა:</strong> ადამიანების ფარული მოტივების, ემოციებისა და ქცევების ამოცნობა.</li>\n              <li><strong>ტოქსიკურობის ნეიტრალიზება:</strong> გუნდური კრიზისებისა და ფარული ოპოზიციის მართვა.</li>\n              <li><strong>შთაგონებით ლიდერობა:</strong> გარემოს შექმნა, სადაც ადამიანები იხარჯებიან იდეისთვის.</li>\n              <li><strong>Island of Sanctuary:</strong> საკუთარი მენეჯერული „ჩრდილის“ (Shadow) იდენტიფიცირება და ეგოს ტრანსფორმაცია.</li>\n            </ul>\n          </div>\n\n          <div class=\"word-section-title\">📚 კურსის სრული სტრუქტურა (12 შეხვედრა):</div>\n\n          <div class=\"word-section-title\" style=\"font-size:0.95rem; color:#0f766e;\">🟢 ნაწილი I: ლიდერობის ფარული ფსიქოლოგია (8 შეხვედრა)</div>\n          <div class=\"meeting-timeline-grid\">\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">01</span><div class=\"meeting-info\"><strong>შესავალი და უსაფრთხო სივრცე</strong><span>კურსის მიდგომები; Island of Sanctuary-ის პრინციპი; მოლოდინების დიაგნოსტიკა.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">02</span><div class=\"meeting-info\"><strong>ლიდერის ავტოპორტრეტი</strong><span>მენეჯერული „ჩრდილის“ (Shadow) იდენტიფიცირება; პიროვნების ბირთვი.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">03</span><div class=\"meeting-info\"><strong>გუნდის დინამიკა</strong><span>კოლექტიური არაცნობიერი; როლები: ვინ არის გუნდის „გული“, „ტვინი“ და „ფარული ოპოზიცია“.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">04</span><div class=\"meeting-info\"><strong>გავლენა და კონფლიქტები</strong><span>ნდობის მოპოვება; დაპირისპირების აქცევა განვითარების რესურსად.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">05</span><div class=\"meeting-info\"><strong>ემოციური ინტელექტი (EQ)</strong><span>აღიარების, მიკუთვნებულობისა და თვითაქტუალიზაციის მოთხოვნილება.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">06</span><div class=\"meeting-info\"><strong>ემოციური ეკოლოგია</strong><span>მენეჯერული და გუნდური გადაწვა (Burnout); ეკოლოგიური ველების შექმნა.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">07</span><div class=\"meeting-info\"><strong>კოგნიტური შეცდომები</strong><span>აზროვნების ავტომატური მოდელები სტრესის დროს; ილუზიები და პროექციები.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">08</span><div class=\"meeting-info\"><strong>I ბლოკის შუალედური აუდიტი</strong><span>საკუთარი ლიდერული რესურსების შეფასება; ინდივიდუალური დავალება.</span></div></div>\n          </div>\n\n          <div class=\"word-section-title\" style=\"font-size:0.95rem; color:#0f766e; margin-top:14px;\">🔵 ნაწილი II: პრაქტიკული ინტეგრაცია და მეტაფორები (4 შეხვედრა)</div>\n          <div class=\"meeting-timeline-grid\">\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">09</span><div class=\"meeting-info\"><strong>არქეტიპები და ეგოს ტრანსფორმაცია</strong><span>Level 5 Leadership და Servant Leadership (მსახური ლიდერი). ლალი ბადრიძის 10 ოქროს წესი.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">10</span><div class=\"meeting-info\"><strong>ტრანს-კულტურული ფსიქოლოგია</strong><span>მენტალური კოდები; მრავალფეროვნების მართვა და სინერგიად ქცევა.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">11</span><div class=\"meeting-info\"><strong>მეტაფორის ძალა</strong><span>ფსიქოთერაპიული ინსტრუმენტები; არაპირდაპირი კომუნიკაცია წინააღმდეგობების დასაძლევად.</span></div></div>\n            <div class=\"meeting-timeline-item\"><span class=\"meeting-num\">12</span><div class=\"meeting-info\"><strong>ფინალური ტრანსფორმაცია</strong><span>ტრანსფორმირებული ლიდერული მოდელების პრეზენტაცია და გზამკვლევი.</span></div></div>\n          </div>\n\n          <div class=\"word-section-title\">🗓️ ფორმატი და მიღება</div>\n          <table class=\"word-meta-table\">\n            <tr><td>⏱️ ხანგრძლივობა</td><td>12 შეხვედრა (კვირაში 1, 3 საათი)</td></tr>\n            <tr><td>📍 ლოკაცია</td><td>„მეტაფორა“ • აღმაშენებლის 63ა</td></tr>\n            <tr><td>🚀 მიღების წესი</td><td>ორეტაპიანი: 1. სააპლიკაციო ფორმის შევსება ➔ 2. პირისპირ გასაუბრება ლალი ბადრიძესთან</td></tr>\n          </table>\n        </div>\n      "
                },
                "EN": {
                        "title": "🧠 Human Psychology in Leadership",
                        "html": "\n        <div class=\"word-doc-container\">\n          <div class=\"word-quote-box\">\n            “Until you make the unconscious conscious, it will direct your life and you will call it fate.”\n            <cite>— Carl Gustav Jung</cite>\n          </div>\n          <p>A master-level course for leaders. Explore organizational psychology, team dynamics, shadow work, and Servant Leadership across 12 comprehensive modules.</p>\n        </div>\n      "
                }
        }
};
