...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================================================
        ...
        },
        {
            ...
            jobtitle: 'კომუნის მენეჯერი & კლუბების მასპინძელი',
    ...
    const I18N_DICTIONARY = {
        ...
        "ნათია — პოზიტიური ფსიქოთერაპევტი & ფსიქოკონსულტანტი": "Natia — Positive Psychotherapist & Psychoconsultant",
        "ელენე — კომუნის მენეჯერი &amp; კლუბების მასპინძელი": "Elene — Community Manager &amp; Clubs Host",
        "ელენე — კომუნის მენეჯერი & კლუბების მასპინძელი": "Elene — Community Manager & Clubs Host",
    ...
    const I18N_DYNAMIC_DATA = {
        KA: {
            ...
            testimonials: [
                ...
                { name: 'ელენე', jobtitle: 'კომუნის მენეჯერი & კლუბების მასპინძელი', text: 'მეტაფორა Clubs არის შენი „მესამე სივრცე“ — ადგილი, სადაც თავს ყოველთვის შინაურად, მყუდროდ და თავისუფლად იგრძნობ თანამოაზრეებთან ერთად.' },
